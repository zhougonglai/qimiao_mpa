...
const tab = {
  ...
  service: () => <div className={classNames(styles.content)}>
    <p className="indent-5">
...
function Tab({ title, activeKey = 'about' }) {
  return (
    <article className={classNames(styles.content)}>
      <div className={classNames(styles.title, 'cursor-default')}>{title}</div>
      <div className={classNames(styles.body, 'mt-4 flex flex-col items-center')}>
        {
          tab[activeKey]()
        }
      </div>
